...
$(NAME): $(LIBFT) $(OBJ)
	...
	@printf "\n\033[38;5;196m"
	@printf "  ╔═════════════════════════════════════════════════════╗\n"
	@printf "  ║\033[38;5;220m       M I N I D E V I L    I S    R E A D Y         \033[38;5;196m║\n"
	@printf "  ╠═════════════════════════════════════════════════════╣\n"
	@printf "  ║\033[38;5;208m   run ./minishell --ui  to enable the DEVIL MODE    \033[38;5;196m║\n"
	@printf "  ║\033[0m   run ./minishell for the standard mode             \033[38;5;196m║\n"
	@printf "  ╚═════════════════════════════════════════════════════╝\033[0m\n\n"
