...
{
	const char	*mystic[] = {
		C_MYSTIC1, C_MYSTIC2, C_MYSTIC3, C_MYSTIC4, C_MYSTIC5};
...
void	animate_quote(t_welcome_term *t)
{
	...
	row = t->center_y - 9;
	print_centered(t, row, C_AURA3
		"╔════════════════════════════════════════════╗" RESET, 46);
	ft_msleep(100);
	print_quote_lines(t, row);
	print_centered(t, row + 4, C_AURA3
		"╚════════════════════════════════════════════╝" RESET, 46);
}
