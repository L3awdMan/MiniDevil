...
/*   Updated: 2026/03/06 06:41:28 by baelgadi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * 
 * Parses a simple command or a subshell and wraps it in redirection nodes
 * as long as redirection tokens follow. After each redirection it collects
 * any trailing word tokens and adds them to the command's args
 * 
 * @param tokens Pointer to current token pointer (advanced)
